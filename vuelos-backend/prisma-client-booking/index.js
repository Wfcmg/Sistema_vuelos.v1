...
const config = {
  ...
  "inlineSchemaHash": "e90ede0c24ca921e9a993356d6088fd82668accabf86865711c741f2e1f9edf4",
  "copyEngine": true
}
...
path.join(process.cwd(), "prisma-client-booking/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "prisma-client-booking/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma-client-booking/schema.prisma")
