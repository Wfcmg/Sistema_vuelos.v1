...
// ============================================================
// RUTA_PUBLICA_WILLIAM_CARRION_VUELOS
// Endpoint publico solicitado para identificar el proyecto.
// Se coloca ANTES del proxy para no romper microservicios,
// Prisma, bases de datos ni rutas existentes.
// ============================================================
app.get([
  '/api/v1/William-Carrion/vuelos',
  '/api/v1/William-Carrión/vuelos',
  '/api/v1/william-carrion/vuelos'
], (_req, res) => {
  res.status(200).json({
    success: true,
    ...
    project: 'vuelos',
    route: '/api/v1/William-Carrion/vuelos',
    aliases: [
      '/api/v1/William-Carrión/vuelos',
      '/api/v1/william-carrion/vuelos'
    ],
    visibility: 'public',
    message: 'Ruta publica del proyecto de vuelos activa desde el API Gateway',
    gateway: 'api-gateway',
    status: 'online',
    version: '2.0.0',
